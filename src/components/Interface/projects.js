...
import { GetSector, GetSectors } from "../utils/API/firebase.service";
  ...
  padding: 20px 25px;`
      ...
      >
        {filter.map((title) => (
          ...
          >
            <p style={secondHeader} onClick={handleGroups} id="selfhead">
              {title}
            </p>
            <div className="list">
