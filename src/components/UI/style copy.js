...
export const SearchBar = styled.input`
  ...
  &:focus{
    outline: 1px solid ${props => props.theme.panelColor};
    box-shadow: ${props => props.theme.searchFocus} ${props => props.theme.LiHover};
    -webkit-box-shadow: ${props => props.theme.searchFocus} ${props => props.theme.LiHover};
    -moz-box-shadow: ${props => props.theme.searchFocus} ${props => props.theme.LiHover};
  }
`
