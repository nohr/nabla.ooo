...
function About() {
  ...
  useEffect(() =>{
    ...
    return (
      <div className="container" has-scroll-dragging="true" data-scroll-container ref={ref}>
        <div className="head">
        <h1>About</h1>
        </div>
          <div className="feed under">{text} <img src="https://global.yamaha-motor.com/design_technology/design/concept/motoroid/img/sec03_img05.jpg" alt="bike" width="800" /></div>
          <img className="feed large" src="https://global.yamaha-motor.com/design_technology/design/concept/motoroid/img/sec03_img05.jpg" alt="bike" width={1400} />
          <div className="feed pic"><img src="https://global.yamaha-motor.com/design_technology/design/concept/motoroid/img/sec03_img05.jpg" alt="bike" width="1000" />{text}</div>
